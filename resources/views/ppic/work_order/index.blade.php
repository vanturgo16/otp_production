                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="so_customer_table" class="table table-bordered"
                                    style="font-size: smaller; min-width: 80rem;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="align-middle text-center" data-name="date">Product</th>
                                            <th class="align-middle text-center" data-name="so_type">Proccess<br>Production</th>
                                            ...
                                            <th class="align-middle text-center" data-name="reference_number">
                                                Unit<br>Proccess</th>
                                            <th class="align-middle text-center">Product Needed</th>
