...
<html lang="en"><head>
    ...
    <title>REPORT FOLDING</title><!--Tinggal Uji COBA DELETE REPORTNYA -->
    <style type="text/css">
      th{
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          <table border="1" cellpadding="0" cellspacing="0" style="table-layout: auto;width: 100%">
            ...
            <tr>
              <td style="background-color: #ecf0f1;">LAPORAN PRODUKSI FOLDING</td>
            </tr>
            <tr>
      ...
      <div class="row mt-3">
        <div class="col-md-3" style="font-size: 13px;">
          <table class="">
			...
			<?php $order_name = explode('|', $data[0]->order_name) ?>
            <tr>
              <td>Nama Order</td>
              <td>: {{ $order_name[2] }}</td>
            </tr>
        ...
        <div class="col-md-4" style="font-size: 12px;">
          ...
          <table border="1" cellpadding="0" cellspacing="0" style="table-layout: auto;width: 95%">
            ...
            <tr>
              ...
              <td class="pl-2">Segitiga Pelipat</td>
              <td class="pl-2">Sesuai Standar</td>
              <td class="text-center"> {{ $data_detail_preparation[0]->segitiga_pelipat=="Ok"?'✓':''; }} </td>
              <td class="text-center"> {{ $data_detail_preparation[0]->segitiga_pelipat=="Not Ok"?'✓':''; }} </td>
            </tr>
            <tr>
        ...
        <div class="col-md-12" style="font-size: 13px;">
          <table border="1" cellpadding="0" cellspacing="0" style="table-layout: auto;width: 100%">
			...
			<?php if(!empty($data_detail_production[0])){ ?>
				...
				<?php $order_names = explode('|', $data_detail->order_name_blow) ?>
