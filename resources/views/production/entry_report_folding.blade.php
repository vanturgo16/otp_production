            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18"> Report Folding</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Production</a></li>
                                <li class="breadcrumb-item active"> Report Folding</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <a href="/production-ent-report-folding-add" class="btn btn-success waves-effect waves-light">
                            ...
                            <div class="table-responsive">
								...
								<script type="text/javascript">
								  $(function () {
									var table = $('.datatable-rb-json').DataTable({
										processing: true,
										serverSide: true,
										ajax: '/production-ent-report-folding-json',
										columns: [
								...
								<script>
									function showPreparation(id)
									{
										$.ajax({
											type: "GET",
											url: "/production-ent-report-folding-json-preparation",
											data: "id='"+id+"'",
											dataType: "html",
								...
								<script>
									function showHygiene(id)
									{
										$.ajax({
											type: "GET",
											url: "/production-ent-report-folding-json-hygiene",
											data: "id='"+id+"'",
											dataType: "html",
											success: function (response) {
